...
--            the open authenticated/anon grant and rely on service_role for any
--            future access path. The drift check (SERVICE_ROLE_ONLY) treats them as
--            deny-all-correct and skips the policy-lint check accordingly.
--
