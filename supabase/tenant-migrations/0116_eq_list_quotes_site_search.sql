-- Migration 0116
-- eq_list_quotes — extend search to cover site code and site name.
-- Site codes like SY6, SY7 are primary keys in the SKS workflow.
...
VALUES ('0116_eq_list_quotes_site_search', NULL)
